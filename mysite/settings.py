...
SECRET_KEY = 'django-insecure-i&=z@dn)w!1=_^97nx^(=&qirgw!%v^c4ipi#--ac#@9#f4gfp'
...
# I have added the following line to prevent warnings about auto-created primary keys.
